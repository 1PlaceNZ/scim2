 ...
 * of {@link PatchOperationWithValue} elements, where each patch operation represents a
 ...
 *       PatchOperationWithValue.replace("active", true)
 *   );
 * </pre>
 *
    ...
    implements Iterable<PatchOperationWithValue>
{
   ...
   */
  @JsonCreator
  public PatchRequestWithValue(
      @JsonProperty(value = "Operations", required = true)
      final List<PatchOperationWithValue> operations)
  {
   ...
   */
  public PatchRequestWithValue(final PatchOperationWithValue operation,
                      final PatchOperationWithValue... operations)
  {
   ...
   */
  public List<PatchOperationWithValue> getOperations()
  {
   ...
   */
  @Override
  public Iterator<PatchOperationWithValue> iterator()
  {
  ...
  {
    for(PatchOperationWithValue operation : this)
    {
  ...
  public boolean equals(final Object o)
  {
    ...
    PatchRequestWithValue that = (PatchRequestWithValue) o;
